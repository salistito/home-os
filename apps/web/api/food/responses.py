...
_STATUS_HTTP = {
    ...
    FoodOperationStatus.INVALID_POINTS_AWARDED: HTTPStatus.BAD_REQUEST,
...
_STATUS_MESSAGE = {
    ...
    FoodOperationStatus.INVALID_POINTS_AWARDED: "Points must be greater than 0.",
...
def serialize_recipe(recipe: Recipe) -> dict:
    return {
        ...
        "points_awarded": recipe.points_awarded,
        "points_min_portions": recipe.points_min_portions,
        "steps": recipe.steps,
