...
<template>
  <div class="mx-auto max-w-5xl space-y-4">
    ...
    <div v-else>
      <div
        class="hidden grid-cols-[1fr_6rem_9rem_5rem_5.25rem] items-center gap-3 border-b border-slate-100 bg-slate-50/60 px-4 py-2 text-xs font-semibold tracking-wider text-slate-400 sm:grid"
      >
        <span>Nombre</span>
        <span>Rol</span>
