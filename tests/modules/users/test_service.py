...
def test_create_user_creates_via_repository(mock_repo, mock_hash, db_user):
...
@pytest.mark.unit
@patch("modules.users.service.repository")
def test_create_user_already_exists_by_name(mock_repo, db_user):
...
@pytest.mark.unit
@patch("modules.users.service.repository")
def test_create_user_telegram_chat_id_taken(mock_repo, db_user):
    mock_repo.get_active_user_by_name.return_value = None
    mock_repo.get_active_user_by_telegram_chat_id.return_value = db_user

    with pytest.raises(UserAlreadyExistsError) as exc:
        create_user("NewUser", telegram_chat_id="123")
    assert exc.value.user == db_user
...
@patch("modules.users.service.repository")
def test_create_user_with_password_calls_hash_and_update(mock_repo, mock_hash, db_user):
    mock_repo.get_active_user_by_name.return_value = None
    mock_repo.get_active_user_by_telegram_chat_id.return_value = None
    mock_repo.create_user.return_value = db_user
    mock_repo.get_active_user_by_id.return_value = db_user

    result = create_user("NewUser", password="secret")
...
@pytest.mark.unit
@patch("modules.users.service.repository")
def test_create_user_with_telegram_chat_id_calls_update(mock_repo, db_user):
    mock_repo.get_active_user_by_name.return_value = None
    mock_repo.get_active_user_by_telegram_chat_id.return_value = None
    mock_repo.create_user.return_value = db_user
    mock_repo.get_active_user_by_id.return_value = db_user

    result = create_user("NewUser", telegram_chat_id="123")
...
@pytest.mark.unit
@patch("modules.users.service.repository")
def test_create_user_no_password_or_telegram_returns_directly(mock_repo, db_user):
    mock_repo.get_active_user_by_name.return_value = None
    mock_repo.get_active_user_by_telegram_chat_id.return_value = None
    mock_repo.create_user.return_value = db_user
